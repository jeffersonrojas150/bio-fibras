...
const ProductDetail = () => {
  ...
  const { cartItems: cart, addToCart, loading: cartLoading } = useCart();
  ...
  // CAMBIO 2: La página se mostrará como "cargando" mientras el producto O el carrito se cargan.
            ...
            <div className="product-info-panel">
              ...
              <div className="quantity-and-stock-section mb-4">
                ...
                <div className="quantity-control-group">
                  ...
                  <Button variant="outline-secondary" size="sm" className="quantity-btn" onClick={() => handleQuantityChange(1)} disabled={quantity >= availableStock}>
                    <FaPlus />
                  </Button>
                </div>
                ...
                {availableStock <= 0 && quantityInCart > 0 && (
                  <Alert variant="info" className="mt-2 small">
                    Ya tienes la cantidad máxima ({quantityInCart}) de este producto en tu carrito.
                  </Alert>
                )}
              </div>
              ...
              <div className="main-actions mb-4">
                <Button className="add-to-cart-btn w-100 mb-3" onClick={handleAddToCart} disabled={availableStock <= 0}>
